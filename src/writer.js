export default sugar =>
  sugar
    ...
    .property('param', [['Number', 'page', '第几页起'], ['Number', 'limit', '每页几条']])
    .property('success', [['200', 'Number', 'code', '返回代码'], ['200', 'String', 'msg', ' 返回描述']])
    .property('fail', [['404', 'Number', 'code', '返回代码'], ['404', 'String', 'msg', ' 返回描述']])
